      ...
      <div class="main-content-header">
        <form method="post" action="result.php">
          ...
          <table class="table2">
              ...
              <th>Hindi</th>
                <th><?php echo $data=$_POST['u_hindi1']; ?></th>
                <th><?php echo $data=$_POST['u_hindi2']; ?></th>
                <th><?php echo $data['u_hindi1']+$data['u_hindi2']; ?> </th>
                <th>200</th>
              </tr>
              <tr>  
              <th>English</th>
              ...
              <th>Total</th>
                  <th>
                   <?php echo $data['u_hindi1']+$data2['u_english1']+$data2['u_math1']+$data2['u_physics1']+$data2['u_chemestry1']; ?>
                  </th>
                  <th>
                  <?php echo $data['u_hindi2']+$data2['u_english2']+$data2['u_math2']+$data2['u_physics2']+$data2['u_chemestry']; ?>
                  </th>
